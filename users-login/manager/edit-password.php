  ...
  <div class="modal-content">
    ...
    <section class="section add-sc" id="editpass">
      ...
      <article class="pass-article">
        ...
        <label for="name">
          <span>Name</span>
          <input type="text" name="name" id="name" value="<?php echo $manager['first_name'].' '.$manager['last_name'] ; ?>" readonly>
        </label>
        <label for="Email">
          <span>Email</span>
          <input type="text" name="email" id="email" value="<?php echo $manager['email'];?>" required>
        </label>
        <label for="number">
          <span>Phone</span>
          <input type="tel" name="phone" id="phone" value="<?php echo $manager['phone'];?>" required>
        </label>
        <label for="password">
            <span>New Password</span>
            <input type="password" minlength="8" name="password" id="password"  style="color: black;" >
          </label>
          <div class="warn fas fa-exclamation-triangle"> If you don't want to change password keep it empty.</div>
