...
session_start();
 ...
 if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "SELECT * FROM manager WHERE email='$username'";
...
<html lang="en" ng-app="myApp">
  ...
  <script src="../../app/app.js"></script>
    ...
    />
    <title>Manager Login - WeOwl</title>
  </head>
  <body ng-controller="myController">
    <article>
      <h2 class="form-title">Login as Manager</h2>
      <form action="#" method="POST">
        ...
        <div class="another-options">
          ...
          <a href="../vicemanager/vicemanager-login.php"
            >login as Vice Manager</a
          >
        </div>
      </form>
    </article>
