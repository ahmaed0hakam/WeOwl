...
$query="SELECT subjects.id FROM subjects WHERE subjects.name = '$subject';";
$result = mysqli_query($conn , $query);
...
$content = 'Teacher '.$teacher_first_name.' '.$teacher_last_name.' '.'Added to the system';

$sql = "INSERT INTO notifications (user_type,user_id, title, content, viewed)
 VALUES ('manager',140842,'ViceManager added a new teacher' , '$content' , 0);";
mysqli_query($conn, $sql);
