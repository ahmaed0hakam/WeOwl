...
$(document).ready(function() {
  $('#handleform').submit(function(e) {
    ...
    var tscId = <?php echo $TSC_ID; ?> // Replace 'your_tsc_id_value' with the actual TSC_ID value

    // Append the TSC_ID to the form data
    formData += '&tsc_id=' + tscId;
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        var newMessageHtml = '<div class="msg-div others"><span class="text">' + message + '</span><h6>sent Today by You at ' + getCurrentTime() + '</h6></div>';
