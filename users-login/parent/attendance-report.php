...
WHERE student_id=$std_id AND dates = '$date' ORDER BY dates desc;
";
$r = mysqli_query($conn, $sql);

$attendances = mysqli_fetch_array($r);
...
<html lang="en" ng-app="myApp">
  ...
  <div class="modal-content">
    ...
    <section class="section classes">
      ...
      <h2 class="title">Attendance Report for <?php echo $date ;?></h2>
      <p class="class">Class:  <?php echo $row['class_name']."(".$row['section'].")"; ?></p>
      <div class="buttons-scroll">

          <a>Student Name:<button disabled ><?php  echo $student['first_name'].' '.$student['last_name'];?></button></a>
          <a>Class:<button disabled ><?php  echo $attendances['class_id'].$student['section'];?></button></a>
          <a>Attendance Status:<button disabled ><?php  echo $attendances['arrival_status'];?></button></a>
          <?php 
            if($attendances['arrival_status']=='Absent'){
          ?>
                <a>Absent Taken at:<button disabled ><?php  echo $attendances['arrival'];?></button></a>
          <?php } ?>
          <?php 
            if($attendances['arrival_status']=='Arrived'){
          ?>
                <a>Arrived at:<button disabled ><?php  echo $attendances['arrival'];?></button></a>
                <a>left at:<button disabled ><?php  echo $attendances['leaving'];?></button></a>
          <?php } ?>
