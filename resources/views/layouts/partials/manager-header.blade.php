<header>
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
        <div class="container">
            <a href="{{ route('manager.dashboard') }}" class="navbar-brand">
                                ...
                                <li class="nav-item dropdown notification">
                                    ...
                                    <ul class="notification-list dropdown-menu dropdown-menu-dark dropdown-menu-end">
                                        <li class="dropdown-item">
                                            <a href="{{ route('manager.profile') }}" class="nav-link">Profile</a>
                                        </li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li class="dropdown-item">
                                            <a href="{{ route('manager.logout') }}" class="nav-link">Logout</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
