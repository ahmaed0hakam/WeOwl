...
@section('title', 'Parent Login - WeOwl')
            ...
            <div class="col-md-6 col-lg-4">
                <div class="dashboard-card">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h2 class="welcome">Parent Login</h2>
                    ...
                    <div class="text-center mt-4">
                        <p>Don't have an account? <a href="{{ route('register.parent') }}" class="text-decoration-none">Register here</a></p>
